...
OBJECT_DETAIL_RULES_BY_LANG: dict[str, dict[str, object]] = {
    "ko": {
        "command_hint": r"(?:요약(?:해|해서)?|정리(?:해|해서)?|보내(?:줘|주세요)?|전달(?:해|해줘|해주세요)?|발송(?:해|해줘|해주세요)?|공유(?:해|해줘|해주세요)?|확인(?:해|해줘|해주세요)?)",
        "patterns": [
...
SPACY_SIGNAL_PATTERNS_BY_LANG: dict[str, dict[str, str]] = {
    "ko": {
        "person": r"(?:^|\s|,)([가-힣]{2,4})(?=(?:가|이|님|씨|에게|한테|께|의|\s*,)\b)",
